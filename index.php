...
function generateTM()
{
    ...
    $stagesString .= generateFinalState();
...
{
    global $finalStateMax, $finalStateDelimiter;
    $final = $finalStateDelimiter;

    $states = mt_rand(1, $finalStateMax);

    for ($i=0; $i < $states; $i++) {
        $final .= randStageNumber() . '0';
    }

    return rtrim($final, '0');
}
